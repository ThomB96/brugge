    ...
    var C1 = localStorage.getItem("C1");
        if (C1 === "true"){
            ...
            document.getElementById("button1_hidden").style.display = 'initial';
                ...
                image1.src = "../img/opdrachten/karaoke-160752.svg"
                image1_1.src = "../img/opdrachten/karaoke-160752.svg"
            }
    ...
    var C4 = localStorage.getItem("C4");
        if (C4 === "true"){
            ...
            document.getElementById("button4_hidden").style.display = 'initial';
                ...
                image1.src = "../img/opdrachten/irish-whiskey-2152126_1280.jpg"
                image1_1.src = "../img/opdrachten/irish-whiskey-2152126_1280.jpg"
            }
